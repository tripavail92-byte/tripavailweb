...
export default function HomeScreen({ onNavigate, activeTab = 'home', showDashboard = false }: HomeScreenProps) {
          ...
          <div className="relative z-10 p-6 h-full flex flex-col justify-center text-white">
            <div className="flex items-start justify-between mb-4">
              ...
              >
                ...
                <p className="text-sm text-white/80 mb-4">{destinations[currentSlide]?.description}</p>
                
                <motion.button
                  onClick={() => onNavigate(`destination-${destinations[currentSlide]?.id}`)}
                  className="px-4 py-2 bg-white text-gray-900 font-semibold rounded-lg shadow-lg flex items-center gap-2 border-2 border-white/20"
                  whileTap={{ scale: 0.95 }}
                  whileHover={{ 
